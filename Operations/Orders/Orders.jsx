    ...
    return(
        <div>
            ...
            <div className="d-flex justify-content-between align-items-center p-1" style={{backgroundColor:'#c7c8cc'}}>
                <div>
                    <span className="pe-3 mouse-pointer" onClick={togglecurrentOrder}>Current Orders</span>
                    <span className="pe-3 mouse-pointer" onClick={toggleonlineOrder}>Online Orders</span>
                    <span className="mouse-pointer" onClick={toggleadvanceOrder}>Advance Orders</span>
                </div>
                <Back/>
            </div>
            {
